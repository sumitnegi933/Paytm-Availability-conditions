YUI.add('moodle-availability_paytm-form', function (Y, NAME) {
    ...
    M.availability_paytm.form.getNode = function (json) {
        ...
        for (var curr in this.currencies) {
          ...
          var html = '<div class="form-group row fitem">';
        html += '<div class="col-md-4"><label class="col-form-label d-inline ">';
        html += M.util.get_string('currency', 'availability_paytm');
        html += '</label></div>';
        html += '<div class="col-md-8">';
        html += '<select class="form-control" name="currency" />' + currencies_options + '</select>';
        ...
        html += '</label></div>';
        html += '<div class="col-md-8">';
        html += '<input class="form-control" name="cost" type="text" />';
        html += '</div>';
        html += '</div>';
        ...
        html += '</label></div>';
        html += '<div class="col-md-8">';
        html += '<input class="form-control" name="itemname" type="text" />';
        html += '</div>';
        html += '</div>';
        ...
        html += '</label></div>';
        html += '<div class="col-md-8">';
        html += '<input class="form-control" name="itemnumber" type="text" />';
        html += '</div>';
        html += '</div>';
